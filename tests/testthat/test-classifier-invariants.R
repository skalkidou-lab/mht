...
#
# WHAT THEY ARE SCOPED TO. This ladder carries 116 rungs and it reads
...
# values the declared categories. 116 rungs, and no pattern repeats.
#
...
test_that("v20260828: the rung sequence matches its frozen declared table", {
  ...
  expect_length(FROZEN_RUNG_DECLARED_20260828, 116L)
})
